...
Public Module GanttDataProvider
	...
	Private Function CreateTasks() As List(Of Task)
		...
		result.Add(CreateTask("2", "1", "Determine project scope", "02/21/2020 08:00:00", "02/21/2020 12:00:00", "100", "1", "2", "1"))
		...
		result.Add(CreateTask("6", "1", "Scope complete", "02/26/2020 12:00:00", "02/26/2020 12:00:00", "0", "0", "2", ""))
		result.Add(CreateTask("7", "0", "Analysis/Software Requirements", "02/26/2020 13:00:00", "03/18/2020 12:00:00", "80", "1", "1", ""))
		...
		Return result
	End Function
'INSTANT VB NOTE: The variable resources was renamed since Visual Basic does not handle local variables named the same as class members well:
	Public Function CreateTask(ByVal id As String, ByVal parentid As String, ByVal subject As String, ByVal start As String, ByVal [end] As String, ByVal percent As String, ByVal type As String, ByVal status As String, ByVal resources_Conflict As String) As Task
		...
		task.Employees = resources_Conflict
		Return task
	End Function
