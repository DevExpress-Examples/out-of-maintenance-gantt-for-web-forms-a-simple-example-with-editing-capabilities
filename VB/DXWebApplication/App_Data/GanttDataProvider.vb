...
Public Module GanttDataProvider
    ...
    Public Function CreateTask(ByVal id As String, ByVal parentid As String, ByVal subject As String, ByVal start As String, ByVal [end] As String, ByVal percent As String, ByVal type As String, ByVal status As String, ByVal resources As String) As Task
        Dim task = New Task()
        task.ID = id
